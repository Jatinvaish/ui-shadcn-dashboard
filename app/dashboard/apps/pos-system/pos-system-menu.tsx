...
import {
  ...
  Table,
  TableCategory
} from "@/app/dashboard/apps/pos-system/store";

import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { RadioGroup } from "@/components/ui/radio-group";
import ProductListItem from "@/app/dashboard/apps/pos-system/components/product-list-item";
import AddProductDialog from "@/app/dashboard/apps/pos-system/components/add-product-dialog";
import ProductCategoryListItem from "@/app/dashboard/apps/pos-system/components/product-category-list-item";
import { ScrollArea, ScrollBar } from "@/components/ui/scroll-area";
import POStSystemCart from "@/app/dashboard/apps/pos-system/components/cart";
import AssignOrderToTable from "@/app/dashboard/apps/pos-system/components/assign-order-to-table";
import POStSystemCartSheet from "@/app/dashboard/apps/pos-system/components/cart-sheet";
