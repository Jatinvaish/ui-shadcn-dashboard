...
import { useStore, Table } from "@/app/dashboard/apps/pos-system/store";
import {
  EnumTableStatus,
  EnumTableStatusColor
} from "@/app/dashboard/apps/pos-system/enums";

import { Badge } from "@/components/ui/badge";
import TableDetailDialog from "@/app/dashboard/apps/pos-system/tables/components/table-detail-dialog";
