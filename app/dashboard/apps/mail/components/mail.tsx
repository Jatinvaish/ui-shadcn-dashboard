...
import { NavDesktop } from "@/app/dashboard/apps/mail/components/nav-desktop";
import { NavMobile } from "@/app/dashboard/apps/mail/components/nav-mobile";
import { MailDisplayMobile } from "@/app/dashboard/apps/mail/components/mail-display-mobile";
