...
import { AddMediaFromUrl } from "@/app/dashboard/pages/products/create/add-media-from-url";
import AddNewCategory from "@/app/dashboard/pages/products/create/add-category";
